...
/private/groups/brookslab/gabai/tools/dorado-0.7.3-linux-x64/bin/dorado basecaller \
    /private/groups/brookslab/gabai/tools/dna_r9.4.1_e8_sup@v3.6 /private/groups/brookslab/gabai/projects/Add-seq/data/chrom/mapping/20190819_chrom.pod5 \
    --emit-moves \
    --device cuda:all \
    --reference /private/groups/brookslab/gabai/projects/Add-seq/data/ref/sacCer3.fa > 20190819_chrom.bam