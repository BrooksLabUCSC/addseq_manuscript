...
python3  /private/groups/brookslab/gabai/tools/NEMO/src/predict.py \
    --bam /private/groups/brookslab/gabai/projects/Add-seq/data/chrom/mapping/20190429_chrom.sorted.bam \
    --parquet /private/groups/brookslab/gabai/projects/Add-seq/data/chrom/mapping/20190429_chrom-sigalign.parquet \
    ...
    --prefix 240912_dorado_20190429_chrom \
    --batch_size 256 \

python3  ~/tools/NEMO/src/plot.py \
    --plot aggregate \
    --pred /private/groups/brookslab/gabai/projects/Add-seq/data/chrom/modPredict/240905_prediction/240912_dorado_20190429_chrom.tsv \
    ...
    --label addseq_nuclei \
    --outpath /private/groups/brookslab/gabai/projects/Add-seq/data/chrom/modPredict/240905_prediction/ \
    --prefix 240912_dorado_20190429_chrom_window2000_nuc \
    --window 2000
...
python3  ~/tools/NEMO/src/plot.py \
    ...
    --label addseq_nuclei \
    --outpath /private/groups/brookslab/gabai/projects/Add-seq/data/chrom/modPredict/240905_prediction/ \
    --prefix 240912_dorado_20190429_chrom_window2000_tts \
    --window 2000
